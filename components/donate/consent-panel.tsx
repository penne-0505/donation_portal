  ...
  return (
    <Card surface="glass" padding="lg" className="p-0">
      <div className="flex flex-col gap-6 p-6 sm:p-8">
        ...
        <div className="flex flex-col gap-3 rounded-2xl glass-sm border-gradient-subtle px-4 py-4 transition-glass">
        ...
        {consentError ? (
          <div
            className="flex items-start gap-2 rounded-md border border-white/30 px-3 py-2 text-sm text-foreground transition-glass glow-status-error"
            role="alert"
          >
